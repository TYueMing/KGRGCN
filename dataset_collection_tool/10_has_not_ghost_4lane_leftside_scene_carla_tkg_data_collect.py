...
def main():
    ...
    try:
        ...
        #
        # # # other-3
        # other_vehicle_bp_3 = blueprint_library.filter('vehicle.*')[10]
        ...
        # new_location_other_3 = spawn_point_other_3.location + forward_distence_3 * 28.0  # 向前移动80米
        ...
        # new_location_other_4 = spawn_point_other_4.location + forward_distence_4 * 50.0  # 向前移动80米

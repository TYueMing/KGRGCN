...
|
|——dataset/          # Our dataset
|      |—— raw_image            # Display the scene image corresponding to each dataset
|      |—— tkgcn_dataset        # The dataset used for training or validation
|
|——dataset_collection_tool/           # Some script code demonstrating how our dataset was collected
|          |—— 9_has_ghost_4lane...
|          |—— ....
|
|——nets/          # Models
...
|
|——TKG/           # TKG＆EKG
|   |——AutoVehicle_EKG_Function_simple_version_V2
|   |——AutoVehicle_KG_Function_3D_simple_version_V2
|
